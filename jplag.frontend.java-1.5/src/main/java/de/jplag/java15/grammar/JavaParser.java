...
import de.jplag.java15.JavaTokenConstants;
...
public class JavaParser implements JavaTokenConstants, JavaParserConstants {
    ...
    private de.jplag.java15.Parser parser2;
    ...
    public static boolean parseFile(File dir, String fileName, JavaParser parser, de.jplag.java15.Parser parserX)
    {
        try {
            FileInputStream in = new FileInputStream(new File(dir,fileName));
            if (parser == null) {
                JavaTabModCharStream charStream = new JavaTabModCharStream(new UnicodeReader(in, StandardCharsets.UTF_8));
                parser = new JavaParser(charStream);
                parser.charStream = charStream;
            } else {
                parser.charStream.ReInit(new UnicodeReader(in, StandardCharsets.UTF_8));
